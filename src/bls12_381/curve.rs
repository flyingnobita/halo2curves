...
mod tests {
    ...
    // TODO [TEST] test_endo_consistency - failed
    // #[test]
    ...
    // TODO [TEST] test_endomorphism - failed because endomorphism_scalars() unimplemented
    // #[test]
    ...
    // FIXME - [TEST] [serde] test_serialization - need to add support for infinity in G1Affine & G2Affine to support serde
    // #[test]
