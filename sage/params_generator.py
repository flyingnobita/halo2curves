...
# This file was *autogenerated* from the file params_generator.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_64 = Integer(64); _sage_const_3 = Integer(3); _sage_const_32 = Integer(32)#!/usr/bin/env sage -python

from sage.all import *

def generate_libff_Fp_model_params(prime):
    num_bits = ceil(log(prime, _sage_const_2 ))
    print('num_bits = {}'.format(num_bits))

    euler = (prime-_sage_const_1 )/_sage_const_2 
    print('euler = {}'.format(euler))

    factorization = factor(prime-_sage_const_1 )
    t = _sage_const_0 
    term_2 = factorization[_sage_const_0 ]
    counter = _sage_const_0 
    if term_2[_sage_const_0 ] != _sage_const_2 :
        raise BaseException("The prime decomposition doesn't have any factor 2."
        "The 'high 2-adicity' requirement isn't respected")
    while not(is_odd(t)):
        s = term_2[_sage_const_1 ] - counter
        t = (prime-_sage_const_1 )/(_sage_const_2 **s)
        counter = counter + _sage_const_1 
    print('s = {}'.format(s))
    is_odd(t); print('t = {}'.format(t))

    t_minus_1_over_2 = (t-_sage_const_1 )/_sage_const_2 
    ...
    word_len_64_bits = _sage_const_64 
    W_64_bits = _sage_const_2 **(word_len_64_bits)
    ...
    Rsquared_64_bits = R_64_bits**_sage_const_2 
    print('Rsquared_64_bits = {}'.format(Rsquared_64_bits))
    Rcubed_64_bits = R_64_bits**_sage_const_3 
    print('Rcubed_64_bits = {}'.format(Rcubed_64_bits))
    inv_64_bits = hex(int(mod((_sage_const_1 /-prime), W_64_bits)))
    print('inv_64_bits = {}'.format(inv_64_bits))

    word_len_32_bits = _sage_const_32 
    W_32_bits = _sage_const_2 **(_sage_const_32 )
    ...
    Rsquared_32_bits = R_32_bits**_sage_const_2 
    print('Rsquared_32_bits = {}'.format(Rsquared_32_bits))
    Rcubed_32_bits = R_32_bits**_sage_const_3 
    print('Rcubed_32_bits = {}'.format(Rcubed_32_bits))
    inv_32_bits = hex(int(mod(_sage_const_1 /-prime, W_32_bits)))
